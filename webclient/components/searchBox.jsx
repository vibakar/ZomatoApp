        ...
        return (
            <div>
              <div style={divStyle}>
                    ...
                    <Button style={inputStyle} size='large' color={this.props.color || this.state.color} onClick={this.onClick.bind(this)}><Icon name={this.props.icon || this.state.icon}></Icon> {this.props.button || this.state.button}</Button>
              </div>
            </div>
        );
    }
