...
import SearchComponent from './components/searchBox.jsx';
import DisplayComponent from './components/display.jsx';
...
class MainComponent extends React.Component {
    ...
    render() {
        return (
          <div>
            <SearchComponent callAjaxCity={this.getCityId.bind(this)} callAjax={this.getResturantDataFromZomato.bind(this)} />
            <DisplayComponent json={this.state.json} />
          </div>
        );
    }
}
ReactDOM.render(<MainComponent />, document.getElementById('mountapp'));
